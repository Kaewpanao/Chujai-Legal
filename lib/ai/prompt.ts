...
export function buildDiagnosisPrompt(args: {
  ...
  const socialProofHint = args.socialProof
    ? `  (ชูใจเคยช่วยคนที่เจอปัญหาแบบนี้มาแล้วประมาณ ${args.socialProof.toLocaleString("th-TH")} คน)`
    : "  (เช่น \"เราเคยช่วยคนที่เจอเรื่องแบบนี้มาแล้วหลายคน\")";
...
- reassurance ต้องมี social proof${socialProofHint} และให้กำลังใจ (empowerment: "คุณจัดการเองได้")
- ห้ามใช้คำว่า รับประกัน / การันตี / ชนะแน่นอน / ชนะ 100% / รับรองว่าชนะ ในทุกกรณี — ให้กำลังใจได้แต่ห้ามสัญญาผลลัพธ์เกินจริง (ใช้คำว่า "เรื่องนี้แก้ได้", "คุณจัดการเองได้", "เราจะช่วยคุณ" แทน)
