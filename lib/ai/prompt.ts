...
{
  "summary": "สรุปสถานการณ์เข้าใจง่าย 1-2 ประโยค",
...
- ทุกสิทธิต้องอ้างชื่อกฎหมายและมาตราให้ตรงกับฐานข้อมูลแหล่งอ้างอิง
...
ให้อธิบายข้อมูลกฎหมายที่เกี่ยวข้องเป็นภาษาไทย เข้าใจง่าย อบอุ่น และตอบเป็น JSON เท่านั้น:
{
  "answer": "คำอธิบาย 2-3 ย่อหน้า ใช้ภาษาคน",
...
ข้อกำหนด:
- อ้างชื่อกฎหมายและมาตราให้ตรงกับฐานข้อมูลแหล่งอ้างอิง ห้ามแต่งมาตรา
