...
${contextBlock}
ให้ตอบคำถามของผู้ใช้โดยตรงเป็นภาษาไทย เข้าใจง่าย อบอุ่น และตอบเป็น JSON เท่านั้น:
{
  "answer": "คำอธิบาย 2-3 ย่อหน้า ที่ตอบคำถามโดยตรง ใช้ภาษาคน อ้างอิงกฎหมายที่ให้มา",
...
ข้อกำหนด:
- ตอบคำถามโดยตรงทันที ห้ามถามกลับว่าต้องการรายละเอียดเพิ่มเติม
- อ้างชื่อกฎหมายและมาตราให้ตรงกับข้อมูลอ้างอิงที่ให้มา ห้ามแต่งมาตรา
- ถ้าไม่แน่ใจเรื่องมาตรา ให้อ้างชื่อกฎหมายโดยไม่ระบุตัวเลขมาตรา
