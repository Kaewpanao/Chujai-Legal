...
export const LEGAL_CATEGORIES: LegalCategory[] = [
  ...
  },
  {
    ...
    socialProof: 980,
    accent: "#dc3e4b",
    keywords: ["ทำร้าย", "ทำร้ายร่างกาย", "ชก", "ต่อย", "ตบ", "รุมทำร้าย", "เย็บแผล", "บาดแผล", "ลักทรัพย์", "ข่มขืน", "อนาจาร", "ขู่", "กรรโชก", "แจ้งความ", "งัด", "ขโมย", "ทอง", "พระ", "บ้านโดนงัด"],
    subProblems: [
  ...
  },
  {
    ...
    socialProof: 760,
    accent: "#7c3aed",
    keywords: ["หมิ่นประมาท", "หมิ่น", "ด่า", "ใส่ความ", "ประจาน", "ว่าร้าย", "นินทา", "ภาพหลุด", "revenge porn", "pdpa", "ข้อมูลรั่ว", "telegram", "รูปโป๊", "โพสต์", "แอบถ่าย"],
    subProblems: [
  ...
  },
  {
    ...
    socialProof: 1120,
    accent: "#0f9f6e",
    keywords: ["ประกัน", "ประกันไม่จ่าย", "ประกันชีวิต", "ประกันรถ", "ประกันสุขภาพ", "เคลม", "เคลมประกัน", "กรมธรรม์", "ยกเลิกกรมธรรม์", "เบี้ยประกัน", "สินไหม", "ไม่จ่ายค่าสินไหม"],
    subProblems: [
  ...
  },
  {
    ...
    socialProof: 1210,
    accent: "#dc2626",
    keywords: ["หนี้", "หนี้สิน", "บัตรเครดิต", "ล้มละลาย", "หนี้นอกระบบ", "ค้ำประกัน", "ผู้ค้ำประกัน", "ทวงหนี้", "ทวง", "เงินกู้", "กู้เงิน", "ดอกเบี้ย", "เจ้าหนี้", "ลูกหนี้"],
    subProblems: [
  ...
  },
  {
    ...
    socialProof: 640,
    accent: "#4f46e5",
    keywords: ["เช่า", "ผู้เช่า", "หอ", "หอพัก", "คอนโด", "อพาร์ทเมนต์", "มัดจำ", "ไม่คืนมัดจำ", "เงินประกัน", "ค่าเช่า", "ไล่ออก", "ห้อง", "ห้องพัก"],
    subProblems: [
  ...
  },
  {
    ...
    socialProof: 1050,
    accent: "#ea580c",
    keywords: ["อุบัติเหตุ", "ชน", "ชนแล้วหนี", "ถูกรถชน", "โดนชน", "เฉี่ยว", "ประมาท", "รถ", "รถจักรยานยนต์", "มอเตอร์ไซค์", "คู่กรณี"],
    subProblems: [
